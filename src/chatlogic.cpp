...
ChatLogic::~ChatLogic()
{
    ...
    // Here i think it was the last problem
    //delete _chatBot;
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot newCbt = ChatBot("../images/chatbot.png");
    newCbt.SetChatLogicHandle(this);
    newCbt.SetRootNode(rootNode);    
    //_chatBot->SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(newCbt));
